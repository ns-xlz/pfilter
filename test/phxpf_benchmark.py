...
if __name__ == "__main__":
    ...
    addrs = [("127.0.0.1", "11261"), ("127.0.0.1", "11262"), ("127.0.0.1", "11263")]
    ...
    for i in range(process_num):
        ts.append(
            PFBenchmarkProcess(
                ...
                addrs, PhxPfGrpcClient, batch_num=batch_num, loop=loop))
    ...
    for func, cost in cost_counter.items():
        print "%s %d times, cost: %.6f, avg cost: %.6f, error cnt: %d" % \
